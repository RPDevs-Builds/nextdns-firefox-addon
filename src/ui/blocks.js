...
function renderSecurityToggles() {
    const SETTING_GROUPS = {
        items: [
            ...
            { id: 'cryptojacking', label: 'Cryptojacking Protection' },
            { id: 'dnsRebinding', label: 'DNS Rebinding Protection' },
            { id: 'idnHomographs', label: 'IDN Homograph Protection' },
            { id: 'typosquatting', label: 'Typosquatting Protection' },
